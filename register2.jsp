...
Statement st=con.createStatement();
un="user"+i;
String sql="insert into oldstd(id,name,lname,address,city,state,zip,phone,email,url,position,company,pwd) values('"+i+"','"+name+"','"+lname+"','"+addr+"','"+city+"','"+state+"','"+zip+"','"+tele+"','"+email+"','"+url+"','"+posi+"', '"+com+"', '"+pwd+"')";
