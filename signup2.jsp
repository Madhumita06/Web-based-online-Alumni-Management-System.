...
<center>
 <form name="reg" action="register2.jsp" method="get"    >
			...
			<input type="text" pattern="[0-9]*" id="zip" onblur = "enableRegisterButton();" onkeypress = "return isNumber(this.value);" name="zip" style="width: 100px;"	 required>
			  ...
			  <tr> 
		   	 ...
		   	 <table align="center" cellpadding="5" cellspacing="5" width="400">
			  <tr> 
                <td><font size="+1"color=#006666><strong>Company</strong>*</font>
				<br>
				<input type="text" name="com"  style="width: 250px;" required	 >
				<td>
				<font size="+1"color=#006666><strong>Position</strong>*</font>
				<br>
				<input type="TEXT" name="posi"  style="width: 250px;" required	 >
			...
			<table align="center" cellpadding="5" cellspacing="5" width="400">
			  <tr> 
                <td><font size="+1"color=#006666><strong>Url</strong>*</font>
				<br>
				<input type="url" name="url" id = "addr" onblur = "enableRegisterButton();" style="width: 500px;"	required >
              </tr>
              <tr> 
               </table>
		   	 <table align="center" cellpadding="5" cellspacing="5" width="400">
